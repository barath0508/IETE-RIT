    ...
    <div className="min-h-screen bg-slate-50 text-brand-text font-body antialiased flex flex-col selection:bg-brand-blue selection:text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-slate-700 hover:text-brand-blue transition-colors px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-blue-50 border border-slate-200/60 cursor-pointer"
            >
            ...
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-slate-800 transition-colors px-3 py-2 rounded-xl hover:bg-slate-100"
            >
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-10 w-full">
        ...
        <nav className="flex items-center gap-2 text-xs font-medium text-slate-500 overflow-x-auto whitespace-nowrap pb-2">
          ...
          <button
            onClick={onNavigateBlog}
            className="hover:text-brand-blue transition-colors cursor-pointer font-medium"
          >
            Blog
          </button>
          <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0" />
        ...
        {otherPosts.length > 0 && (
          <section className="pt-8 border-t border-slate-200 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onNavigateBlog}
                className="text-xs font-bold text-brand-blue hover:underline hidden sm:inline cursor-pointer"
              >
                View All Articles & Reports →
              </button>
            </div>
